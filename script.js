const categories = {
   pokemonprimera: ['Pikachu', 'Charizard', 'Eevee', 'Bulbasaur', 'Squirtle', 'Mew', 'Pidgey', 'Ditto', 'Ivysaur', 'Venusaur', 'Charmander', 'Charmeleon', 'Wartortle', 'Blastoise', 'Caterpie', 'Metapod', 'Butterfree', 'Weedle', 'Kakuna', 'Beedrill', 'Pidgeotto', 'Pidgeot', 'Rattata', 'Raticate', 'Spearow', 'Fearow', 'Ekans', 'Arbok', 'Raichu', 'Sandshrew', 'Sandslash', 'Nidoran♀', 'Nidorina', 'Nidoqueen', 'Nidoran♂', 'Nidorino', 'Nidoking', 'Clefairy', 'Clefable', 'Vulpix', 'Ninetales', 'Jigglypuff', 'Wigglytuff', 'Zubat', 'Golbat', 'Oddish', 'Gloom', 'Vileplume', 'Paras', 'Parasect', 'Venonat', 'Venomoth', 'Diglett', 'Dugtrio', 'Meowth', 'Persian', 'Psyduck', 'Golduck', 'Mankey', 'Primeape', 'Growlithe', 'Arcanine', 'Poliwag', 'Poliwhirl', 'Poliwrath', 'Abra', 'Kadabra', 'Alakazam', 'Machop', 'Machoke', 'Machamp', 'Bellsprout', 'Weepinbell', 'Victreebel', 'Tentacool', 'Tentacruel', 'Geodude', 'Graveler', 'Golem', 'Ponyta', 'Rapidash', 'Slowpoke', 'Slowbro', 'Magnemite', 'Magneton', 'Farfetch’d', 'Doduo', 'Dodrio', 'Seel', 'Dewgong', 'Grimer', 'Muk', 'Shellder', 'Cloyster', 'Gastly', 'Haunter', 'Gengar', 'Onix', 'Drowzee', 'Hypno', 'Krabby', 'Kingler', 'Voltorb', 'Electrode', 'Exeggcute', 'Exeggutor', 'Cubone', 'Marowak', 'Hitmonlee', 'Hitmonchan', 'Lickitung', 'Koffing', 'Weezing', 'Rhyhorn', 'Rhydon', 'Chansey', 'Tangela', 'Kangaskhan', 'Horsea', 'Seadra', 'Goldeen', 'Seaking', 'Staryu', 'Starmie', 'Mr. Mime', 'Scyther', 'Jynx', 'Electabuzz', 'Magmar', 'Pinsir', 'Tauros', 'Magikarp', 'Gyarados', 'Lapras', 'Snorlax', 'Articuno', 'Zapdos', 'Moltres', 'Dratini', 'Dragonair', 'Dragonite', 'Mewtwo'],
            ...
            dbz: ['Goku', 'Vegeta', 'Bulma', 'Krillin', 'Piccolo', 'Gohan', 'Trunks', 'Chi-Chi', 'Yamcha', 'Tenshinhan', 'Chaoz', 'Maestro Roshi', 'Dende', 'Freezer', 'Célula', 'Majin Buu', 'Goten', 'Videl', 'Hercule (Mr. Satan)', 'Bills (Beerus)', 'Whis', 'Gogeta', 'Vegito', 'Broly', 'Bardock', 'Gine', 'Raditz', 'Nappa', 'Zarbon', 'Dodoria', 'Jiren', 'Toppo', 'Hit', 'Kefla', 'Caulifla', 'Kale', 'Frost', 'Moro', 'Zamasu', 'Goku Black', 'Giru', 'Baby', 'Super 17', 'Shenlong', 'Oolong', 'Puar', 'Pilaf', 'Shu', 'Mai', 'Karin (Maestro Karin)', 'Uranai Baba', 'Tao Pai Pai', 'Yajirobe', 'Kaio (King Kai)', 'Kaio del Sur', 'Kaio del Este', 'Kaio del Oeste', 'Gran Kaio', 'Guldo', 'Burta', 'Recoome', 'Jeice', 'Capitán Ginyu', 'Android 16', 'Android 17', 'Android 18', 'Dr. Gero', 'Slump (Lord Slug)', 'Cooler', 'Janemba', 'Garlic Jr.', 'Tapion', 'Bojack', 'Hildegarn', 'Vados', 'Champa', 'Nail', 'Guru', 'Pikkon', 'Gohan (Teen)'],
            taylorswift: ['A Place in This World', 'Cold as You', 'Mary’s Song', 'Our Song', 'Picture to Burn', 'Should’ve Said No', 'Stay Beautiful', 'Teardrops on My Guitar', 'The Outside', 'Tied Together with a Smile', 'Tim McGraw', '...Ready For It?', 'Call It What You Want', 'Dancing with Our Hands Tied', 'Delicate', 'Don\'t Blame Me', 'Dress', 'End Game', 'Getaway Car', 'Gorgeous', 'I Did Something Bad', 'King of My Heart', 'Look What You Made Me Do', 'New Year\'s Day', 'So It Goes...', 'This Is Why We Can\'t Have Nice Things', 'I Forgot That You Existed', 'Cruel Summer', 'Lover', 'The Man', 'The Archer', 'I Think He Knows', 'Miss Americana & the Heartbreak Prince', 'Paper Rings', 'Cornelia Street', 'Death by a Thousand Cuts', 'London Boy', 'Soon You\'ll Get Better', 'False God', 'You Need to Calm Down', 'Afterglow', 'ME!', 'It\'s Nice to Have a Friend', 'Daylight', 'All Of The Girls You Loved Before', 'The 1', 'Cardigan', 'The Last Great American Dynasty', 'Exile', 'My Tears Ricochet', 'Mirrorball', 'Seven', 'August', 'This Is Me Trying', 'Illicit Affairs', 'Invisible String', 'Mad Woman', 'Epiphany', 'Betty', 'Peace', 'Hoax', 'The Lakes', 'Willow', 'Champagne Problems', 'Gold Rush', '\'Tis the Damn Season', 'Tolerate It', 'No Body, No Crime', 'Happiness', 'Dorothea', 'Coney Island', 'Ivy', 'Cowboy like Me', 'Long Story Short', 'Marjorie', 'Closure', 'Evermore', 'Right Where You Left Me', 'It\'s Time to Go', 'Lavender Haze', 'Maroon', 'Anti-Hero', 'Snow on the Beach', 'You\'re on Your Own, Kid', 'Midnight Rain', 'Question...?', 'Vigilante Shit', 'Bejeweled', 'Labyrinth', 'Karma', 'Sweet Nothing', 'Mastermind', 'The Great War', 'Bigger than the Whole Sky', 'Paris', 'High Infidelity', 'Glitch', 'Would\'ve, Could\'ve, Should\'ve', 'Dear Reader', 'Hits Different', 'Sweet Nothing (Piano Remix)', 'Karma (featuring Ice Spice)', 'You\'re Losing Me (From The Vault)', 'Fearless', 'Fifteen', 'Love Story', 'Hey Stephen', 'White Horse', 'You Belong with Me', 'Breathe', 'Tell Me Why', 'You\'re Not Sorry', 'The Way I Loved You', 'Forever & Always', 'The Best Day', 'Change', 'Jump Then Fall', 'Untouchable', 'Forever & Always (Piano Version)', 'Come In With The Rain', 'Superstar', 'The Other Side of the Door', 'Today Was a Fairytale', 'You All Over Me', 'Mr. Perfectly Fine', 'We Were Happy', 'That\'s When', 'Don\'t You', 'Bye Bye Baby', 'Love Story (Elvira remix)', 'If This Was A Movie', 'State of Grace', 'Red', 'Treacherous', 'I Knew You Were Trouble', 'All Too Well', '22', 'I Almost Do', 'We Are Never Ever Getting Back Together', 'Stay Stay Stay', 'The Last Time', 'Holy Ground', 'Sad Beautiful Tragic', 'The Lucky One', 'Everything Has Changed', 'Starlight', 'Begin Again', 'The Moment I Knew', 'Come Back...Be Here', 'Girl at Home', 'State of Grace (Acoustic Version)', 'Ronan', 'Better Man', 'Nothing New', 'Babe', 'Message in a Bottle', 'I Bet You Think About Me', 'Forever Winter', 'Run', 'The Very First Night', 'All Too Well (10 Minute Version)', 'Safe & Sound', 'Eyes Open', 'Mine', 'Sparks Fly', 'Back to December', 'Speak Now', 'Dear John', 'Mean', 'The Story of Us', 'Never Grow Up', 'Enchanted', 'Better than Revenge', 'Innocent', 'Haunted', 'Last Kiss', 'Long Live', 'Ours', 'Superman', 'Electric Touch', 'When Emma Falls in Love', 'I Can See You', 'Castles Crumbling', 'Foolish One', 'Timeless', 'Welcome to New York', 'Blank Space', 'Style', 'Out of the Woods', 'All You Had to Do Was Stay', 'Shake It Off', 'I Wish You Would', 'Bad Blood', 'Wildest Dreams', 'How You Get the Girl', 'This Love', 'I Know Places', 'Clean', 'Wonderland', 'You Are In Love', 'New Romantics', 'Slut!', 'Say Don\'t Go', 'Now That We Don\'t Talk', 'Suburban Legends', 'Is It Over Now?', 'Sweeter Than Fiction'],
...
const categoryNames = {
    ...
    comidas: 'Comidas',
    taylorswift: 'Taylor Swift: Canciones',
